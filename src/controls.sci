ValueFrame = uicontrol(f, "style", "frame", "position", [15 560 305 80]...
...
[45 585 40 30], "string", "t = ", "fontsize", 25);
//
timeValue = uicontrol(f, "style", "text", "position", ...
[85 585 60 30], "string", string(%time)+"s", "fontsize", 25)
//
tempLabel = uicontrol(f, "style", "text", "position", ...
[160 585 50 30], "string", "T = ", "fontsize", 25);
//
tempValue = uicontrol(f, "style", "text", "position", ...
[210 585 105 30], "string", string(%temp)+"ºC", "fontsize", 25)
//
minTempSlider = uicontrol("style", "slider", "position", [60 30 30 520], ...
"min", 0, "max", 45, "sliderstep", [1 5], "value" , %MinTemp, ...
"callback", "changeMinTemp", "tag", "minTempSlider");
//
maxTempSlider = uicontrol("style", "slider", "position", [20 30 30 520], ...
